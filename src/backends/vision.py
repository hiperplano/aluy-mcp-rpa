...
class VisionBackend:
    ...
    # garante OCR < orçamento (nenhuma chamada estoura os 60s do MCP).
    ...
    def _calibrate_canvas(self):
        ...
        try:
            ...
            line = "OK Cancel Save Open 12345 menu file edit close help  " * 3
    ...
    def ocr_tokens(self, image_path: str, region: Optional[dict] = None,
        ...
        # (ex.: telas largas, 1920px) ficam rápidas (<60s, senão o MCP reinicia o
