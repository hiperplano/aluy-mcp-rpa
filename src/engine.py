...
class RpaEngine:
    ...
    def goto(self, target: str, *, click: bool = False) -> "ActionResult":
        ...
        for s in steps:
            ...
            lbl = s.get("to_label")
            if lbl:
                # PROBE estável: o título do diálogo varia (ex.: 'Salvar: doc1'
                # vs 'Salvar: doc2'); mira pelo prefixo até ':' (ou 2 palavras).
    ...
    def click_text(self, text: str, region: Optional[dict] = None, *,
        ...
        # menu-bar custom só selecionava, não abria via Invoke; o clique real abre. Invoke
        ...
        # a11y-first: se o app expõe a árvore de acessibilidade, achar
    ...
    def _clear_field(self, *, n: int = 24):
        ...
        métodos porque campos custom (ex.: spinbox de valor numérico) IGNORAM o
    ...
    def type_text(self, text: str, *, clear: bool = False) -> ActionResult:
        ...
        campos custom de valor numérico).
